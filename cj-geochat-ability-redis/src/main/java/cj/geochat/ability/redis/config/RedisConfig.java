package cj.geochat.ability.redis.config;
...
@ComponentScan(basePackages = {"cj.geochat.ability.redis"})
...
public class RedisConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "spring.data.redis.mode",havingValue = "singleon")

 ...
 * to a {@link #getRegisteredAppId() client}, by the {@link #getPrincipalName() resource owner}
...
public class OAuth2Authorization implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(this.id, that.id) &&
				Objects.equals(this.registeredAppId, that.registeredAppId) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.id, this.registeredAppId, this.principalName,

...
public final class DelegatingAuthMethodConverter implements IAuthenticationConverter {
     ...
     */
    public DelegatingAuthMethodConverter(String defaultConverter, List<IAuthenticationConverter> converters) {
    ...
    public AbstractAuthenticationToken convert(HttpServletRequest request) {
        ...
        String[] auth_type_arr = request.getParameterMap().get("auth_method");

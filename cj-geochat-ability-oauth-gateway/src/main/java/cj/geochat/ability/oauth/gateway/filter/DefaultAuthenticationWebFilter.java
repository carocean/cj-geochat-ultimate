package cj.geochat.ability.oauth.gateway.filter;
 ...
 * {@link #DefaultAuthenticationWebFilter(ReactiveAuthenticationManager)} is used to perform
 * authentication.</li>
 * <li>The {@link ReactiveAuthenticationManagerResolver} specified in
 * {@link #DefaultAuthenticationWebFilter(ReactiveAuthenticationManagerResolver)} is used to
 ...
 * @since 5.0
 */
public class DefaultAuthenticationWebFilter implements WebFilter {

	private static final Log logger = LogFactory.getLog(DefaultAuthenticationWebFilter.class);
	 ...
	 */
	public DefaultAuthenticationWebFilter(ReactiveAuthenticationManager authenticationManager) {
	 ...
	 * @since 5.3
	 */
	public DefaultAuthenticationWebFilter(
